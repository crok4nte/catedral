...
var (
	...
	C2EventNew      = color.New(color.FgHiRed, color.Bold).SprintFunc()
	C2EventCritical = color.New(color.FgHiRed, color.Bold, color.Underline).SprintFunc()
	C2EventInfo     = color.New(color.FgHiWhite).SprintFunc()
)
