...
import (
	"Catedral/pkg/agent"
	"Catedral/pkg/common/certs"
	"Catedral/pkg/db"
	"Catedral/pkg/service"
	"Catedral/pkg/webhook"
	"bytes"
	"encoding/hex"
	"encoding/json"
	"errors"
	...
	"Catedral/pkg/common"
	"Catedral/pkg/events"
	"Catedral/pkg/handlers"
	"Catedral/pkg/logger"
	"Catedral/pkg/packager"
	"Catedral/pkg/profile"
	"Catedral/pkg/utils"
)
...
func (t *Teamserver) Start() {
	...
	// Catch me if you can
	t.Server.Engine.GET("/catedral/", func(context *gin.Context) {
