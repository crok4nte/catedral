...
bool CatedralSpace::DBManager::addTeamserverInfo( const Util::ConnectionInfo& connection )
{
...
bool CatedralSpace::DBManager::checkTeamserverExists( const QString& ProfileName )
{
    auto query   = QSqlQuery();
    auto success = false;
    auto error   = std::string();
...
bool CatedralSpace::DBManager::removeTeamserverInfo( const QString& ProfileName )
{
    auto query = QSqlQuery();
    auto error = std::string();
...
vector<Util::ConnectionInfo> CatedralSpace::DBManager::listTeamservers()
{
    auto query          = QSqlQuery();
...
bool CatedralSpace::DBManager::removeAllTeamservers()
{
    auto query = QSqlQuery();
    auto error = std::string();
