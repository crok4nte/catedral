...
Connector::Connector( Util::ConnectionInfo* ConnectionInfo )
{
    ...
    auto Server  = "wss://" + Teamserver->Host + ":" + this->Teamserver->Port + "/catedral/";
    ...
    {
        auto Package = CatedralSpace::Packager::DecodePackage( Message );
    ...
    {
        this->Packager = new CatedralSpace::Packager;
