...
string CatedralNamespace::Version  = "0.7";
string CatedralNamespace::CodeName = "Bites The Dust";

// Global Variables in the Catedral Namespace
CatedralSpace::Catedral* CatedralNamespace::CatedralApplication;

Util::ConnectionInfo                    CatedralX::Teamserver;
CatedralNamespace::Connector*              CatedralX::Connector;
CatedralNamespace::UserInterface::CatedralUi* CatedralX::CatedralUserInterface;
bool                                    CatedralX::DebugMode = false;
bool                                    CatedralX::GateGUI = false;

QString CatedralSpace::Listener::PayloadHTTPS    = "Https";
QString CatedralSpace::Listener::PayloadHTTP     = "Http";
QString CatedralSpace::Listener::PayloadSMB      = "Smb";
QString CatedralSpace::Listener::PayloadExternal = "External";
