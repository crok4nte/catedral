...
void CatedralNamespace::UserInterface::SmallWidgets::EventViewer::setupUi(QWidget *Widget) {
...
void CatedralNamespace::UserInterface::SmallWidgets::EventViewer::AppendText(const QString& Time, const QString& text) const {
