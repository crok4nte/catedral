...
void CatedralNamespace::UserInterface::Widgets::ProcessList::setupUi(QWidget *Widget) {
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::UpdateProcessListJson( QJsonDocument ProcessListData )
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::NewTableProcess(std::map<QString, QString> ProcessInfo) {
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::NewTreeProcess( std::map<QString,QString> ProcessInfo )
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::onButton_Refresh() const
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::onTableChange()
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::onTreeChange()
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::handleTableListMenuContext( const QPoint &pos )
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::handleTreeListMenuContext( const QPoint &pos )
{
    if ( ! ProcessTable->itemAt( pos ) )
        return;
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::onActionCopyPID()
{
...
void CatedralNamespace::UserInterface::Widgets::ProcessList::onActionSetParentProcess()
{
