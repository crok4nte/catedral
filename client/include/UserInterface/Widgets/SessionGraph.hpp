#ifndef CATEDRAL_SESSIONGRAPH_HPP
#define CATEDRAL_SESSIONGRAPH_HPP
...
public:
    ...
    CatedralNamespace::Util::SessionItem Session;
...
public:
    ...
    Node* GraphNodeAdd( CatedralNamespace::Util::SessionItem Session );
    void  GraphNodeRemove( CatedralNamespace::Util::SessionItem Session );
    Node* GraphNodeGet( QString AgentID );

    void  GraphPivotNodeAdd( QString AgentID, CatedralNamespace::Util::SessionItem Session );
