#ifndef CATEDRAL_TEAMSERVERTABSESSION_H
#define CATEDRAL_TEAMSERVERTABSESSION_H
...
class CatedralNamespace::UserInterface::Widgets::TeamserverTabSession : public QWidget
{
    typedef struct
    {
