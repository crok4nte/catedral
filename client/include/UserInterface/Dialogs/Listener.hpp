...
#ifndef CATEDRAL_LISTENER_HPP
#define CATEDRAL_LISTENER_HPP
...
class CatedralNamespace::UserInterface::Dialogs::NewListener : public QDialog
{
    Q_OBJECT
