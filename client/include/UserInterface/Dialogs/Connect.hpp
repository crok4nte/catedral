#ifndef CATEDRAL_CONNECTDIALOG_H
#define CATEDRAL_CONNECTDIALOG_H
...
class CatedralNamespace::UserInterface::Dialogs::Connect : public QDialog
{
private:
    ...
    CatedralNamespace::CatedralSpace::DBManager* dbManager;
...
public:
    ...
    void passDB( CatedralNamespace::CatedralSpace::DBManager* db );
