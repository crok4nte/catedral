#ifndef CATEDRAL_PACKAGER_H
#define CATEDRAL_PACKAGER_H

#include <global.hpp>

using namespace std;
using namespace CatedralNamespace;
using namespace CatedralSpace;

namespace CatedralNamespace::Util::Packager
{
    typedef struct
    {
        int Event;
